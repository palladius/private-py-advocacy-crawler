...
echo TODO Ricc. Created manually in dev.
echo Create dataset in US called ose_volta_insights
# https://pantheon.corp.google.com/bigquery?referrer=search&e=-13802955&inv=1&invt=AbVwjg&mods=logs_tg_staging&project=ose-volta-dev&ws=!1m4!1m3!3m2!1sose-volta-dev!2sose_volta_insights
